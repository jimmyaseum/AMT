...
class WorldTourListAdapter(val context: Context?, private val arrData: ArrayList<SectorListModel>, val recyclerClickListener: RecyclerClickListener) : RecyclerView.Adapter<WorldTourListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_world_tour_list, parent, false)
