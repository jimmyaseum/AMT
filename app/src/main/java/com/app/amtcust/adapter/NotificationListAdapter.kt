    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            if(model[position].MessageType != null) {
                ...
                else if(model[position].MessageType.equals("PAYMENTRECEIPT"))
                {
                    itemView.image.setImageResource(R.drawable.payment)
                    itemView.image.setColorFilter(ContextCompat.getColor(context, R.color.blue))
                    itemView.txt_Title.setTextColor(context.resources.getColor(R.color.blue))
                    itemView.txt_Date.setTextColor(context.resources.getColor(R.color.blue))
                }
