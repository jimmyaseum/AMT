...
class UpcomingHotelFragment : BaseFragment(), RecyclerClickListener {
    var sharedPreference: SharedPreference? = null
    private var views: View? = null
    private val repo by lazy { NetworkRepo() }
    lateinit var adapter: UpcomingHotelListAdapter
    ...
    private fun GetUpcomingHotelList() {
        ...
        repo.getUpcomingHotel(userId,5, listners = ResponseListner {
            ...
            if (it.status) {
                if (it.data?.Status == 200) {
                    ...
                    if(arrUpcomingHotelList.size > 0) {
                        views!!.rvUpcomingHotelList.adapter = UpcomingHotelListAdapter(activity,arrUpcomingHotelList,this, true)
    ...
    private fun showHideDesignView(mode: Int) {
        ...
        when (mode) {
            ...
            2 -> {
                ...
                views!!.tvNoData.text = "No Upcoming Hotel Voucher Found"
