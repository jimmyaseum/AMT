...
class PersonalInfoFragment  : BaseFragment(), View.OnClickListener  {
    ...
    private fun CallUpdateAPI() {
        ...
        jsonObject.put("IsCustomerUpdate", views!!.cbIsCustomerUpdate.isChecked)
        ...
        val call = ApiUtils.apiInterface.AddTourPersonalInformation(getRequestJSONBody(jsonObject.toString()))
