...
import com.app.amtcust.adapter.dialog.DialogRelationAdapter
...
//                dpd.datePicker.maxDate = System.currentTimeMillis() - 1000
    ...
    private fun CallEditProfileAPI() {
        ...
        var call = apiInterface.CustomerUpdate(
    ...
    private fun CallAddProfileAPI() {
        ...
        var call = apiInterface.CustomerAdd(
    ...
    private fun GetAllCityAPI() {
        ...
        showProgress()
        val call = apiInterface.getAllCity()
    ...
    private fun GetAllRelationAPI() {
        ...
        showProgress()
        val call = apiInterface.getAllRelation()
